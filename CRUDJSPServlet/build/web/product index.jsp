<%-- 
    ...
    Created on : Dec 15, 2018, 12:21:26 AM
    Author     : Farhan Van Nagan
--%>
...
<html>     
    ...
    <body>         
        ...
        <a href="http://<% out.println(request.getServerName()); 
           %>:8080/4SCPJSPServlet /Product_Create">+ Add Product</a><br><br>                  
...
<tr>                                 
    ...
    <td>                                     
        <a href="http://<% out.println(request.getServerName()); 
           ...
           %>">Edit</a>                                      | 
           <a href="http://<% out.println(request.getServerName()); 
              %>:8080/4SCPJSPServlet /Product_Destroy?idprod=<% out.println(rs.getString(1)); %>">Delete</a>                                 </td>                             </tr>                             <%                         }                     }                 %>             </tbody>         </table>         <br>             <%                 String message = request.getParameter("message");                 if (message!=null) {                     if (message.equals("inputsuccess")) { 
